...
Le but de ce premier chapitre est de placer le projet dans son contexte général. Il commence par une présentation de l’organisme d’accueil, l’entreprise MEDIANET, dans lequel le projet a été mené, puis introduit le projet, son contexte et ses objectifs principaux.

\section{Présentation de l'organisme d'accueil}

\textbf{MEDIANET} est une société spécialisée dans les technologies numériques et les services d'ingénierie informatique (SSII).  Spécialiste dans les technologies de l’information et de la communication (TIC), elle développe des solutions numériques pour des clients nationaux et internationaux.
...
Nous présentons dans cette partie le cadre du projet, le contexte du projet E-Gouv, la problématique relevée, les solutions existantes, ainsi que la solution proposée et ses objectifs.
...
\begin{itemize}
    ...
    \item \textbf{Les personnes} : elles représentent tous les acteurs impliqués dans le système, y compris les administrations publiques, les responsables institutionnels, les agents administratifs et les citoyens bénéficiaires des services.
\end{itemize}
...
Pour répondre aux objectifs liés à la modernisation et à la transformation numérique des services publics, ce projet propose la conception et la mise en œuvre d’une \textbf{plateforme web sécurisée et évolutive}. Celle-ci a pour vocation d’améliorer la qualité des services administratifs, de renforcer la coordination entre les différentes administrations et de simplifier l’accès des citoyens aux démarches en ligne.
...
Scrum, Kanban et Extreme Programming (XP) sont parmi les méthodes agiles les plus employées. Scrum convient particulièrement bien aux projets complexes qui nécessitent une forte interaction avec le client et une organisation du travail en cycles courts, appelés \textit{Sprints} \parencite{schwaber2020}. Kanban met l’accent sur la visualisation du flux de travail et surl’amélioration continue, tandis que XP se concentre sur les bonnes pratiquesde développement logiciel.
...
Grande capacité à s'adapter aux évolutions \\ \hline

Implication du client &
Intervention principalement au début et à la fin du projet &
Engagement continu pendant toute la durée du projet \\ \hline
...
Exemples &
Waterfall &
Scrum, Kanban, Extreme Programming (XP) \\ \hline
\rowcolor{white}
...
La méthodologie Scrum a été retenue dans le cadre de ce projet en raison de son approche itérative et incrémentale, de sa flexibilité et de sa capacité à gérer efficacement les changements de priorités. Elle permet en outre d’assurer un suivi régulier du projet et d’adapter progressivement les livrables aux besoins des utilisateurs.
...
\begin{itemize}
    ...
    \item \textbf{Approche itérative et incrémentale} : la structure du travail repose sur des cycles courts, ce qui permet des livraisons régulières et une révision continue des priorités.
...
\end{itemize}
Comme illustré dans la figure \ref{fig:scrum}, le cadre Scrum repose sur une organisation itérative et incrémentale.
\begin{figure}[H]
\centering
...
\begin{itemize}
\item \textbf{Réunion quotidienne (Daily Meeting)} : courte session d’environ 15 minutes permettant de synchroniser l’équipe de partager l’état d’avancement des tâches et d’identifier les éventuels blocages.

\item \textbf{Planification de sprint (Sprint Planning)} : organisée au début de chaque sprint cette réunion réunit l’ensemble de l’équipe afin de définir l’objectif du sprint et de sélectionner les éléments du Product Backlog que l’équipe s’engage à réaliser.

\item \textbf{Revue de sprint (Sprint Review)} : démonstration de l’incrément produit aux parties prenantes permettant sa validation et la collecte de retours.

\item \textbf{Rétrospective de sprint (Sprint Retrospective)} : réunion dédiée à l’analyse des pratiques de l’équipe afin d’identifier des axes d’amélioration et de renforcer la performance des prochains sprints.
...
\begin{itemize}
\item \textbf{Diagramme de cas d’utilisation} : il permet de représenter les besoins fonctionnels du système en mettant en évidence les interactions entre les acteurs et celui-ci.
...
\section{Conclusion}
Ce chapitre nous a permis de présenter le contexte général du projet, l’entreprise d’accueil et la problématique identifiée. Il a également réalisé une analyse de l’existant et présenté la solution proposée. En conclusion, la méthodologie de travail utilisée Scrum a été décrite.