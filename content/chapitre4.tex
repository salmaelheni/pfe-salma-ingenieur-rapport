...
% ===================== CONSULTER =====================
La figure~\ref{fig:etapes-reclamations} présente l’interface de consultation des étapes de traitement des réclamations associées à plusieurs administrations.
...
À l'issue du Sprint 4, l'ensemble des user stories planifiées a été développé et validé, comme présenté dans le tableau~\ref{tab:revue-sprint4}.
...
La figure~\ref{fig:real-assistance-form} présente une réponse du chatbot fondée sur le contenu indexé dans la base vectorielle.
