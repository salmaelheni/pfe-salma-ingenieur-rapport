...
La figure \ref{fig:cas-utilisation-sprint4-raff} présente le diagramme de cas d'utilisation raffiné du cas d'utilisation « Personnaliser les étapes de traitement des réclamations ».
\begin{figure}[H]
    \centering
...
% ===================== AJOUTER =====================
Le diagramme de séquence présenté dans la figure~\ref{fig:ajouter-etape} illustre  le processus d’ajout d’une nouvelle étape de traitement des réclamations. Il décrit les interactions permettant à l’administrateur de créer et d’enregistrer une nouvelle étape dans le workflow existant.
...
% ===================== CONSULTER =====================
La figure~\ref{fig:etapes-reclamations} présente l’interface qui permet à l’administrateur de consulter la liste des étapes de traitement des réclamations associées à une administration. Elle offre une vue globale sur la structure du workflow configuré.
...
% ===================== SUPPRIMER =====================
La figure~\ref{fig:suppression-etape} présente l’interface qui permet à l’administrateur de supprimer une étape du workflow de traitement des réclamations, une confirmation est généralement demandée afin d’éviter toute suppression accidentelle.
...
La figure~\ref{fig:dashboard-statistiques} montre l’interface du tableau de bord de supervision qui affiche les statistiques globales des services et des réclamations avec des indicateurs ventilés par administration et par période.
...
A l'issue du Sprint 5, l'ensemble des user stories planifiées ont été développées et validées comme présenté dans le tableau~\ref{tab:revue-sprint5}.
...
Ce chapitre a présenté la release 2, structurée en deux sprints. Le Sprint 4 a permis de mettre en place la gestion des réclamations, les notifications ainsi que les outils de supervision. Le Sprint 5, quant à lui, a introduit le portail public, incluant une vitrine institutionnelle et un assistant conversationnel basé sur une approche RAG, complété par un canal d’assistance humaine.
